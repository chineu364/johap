var player = {
    ...
    allElement: {
        ...
        "dynamic viscosity": { "L": -1, "T": -1, "M": 1, "I": 0, "TH": 0, "N": 0, "J": 0 },
        "moment of force": { "L": 2, "T": -2, "M": 1, "I": 0, "TH": 0, "N": 0, "J": 0 },
        "surface tension": { "L": 0, "T": -2, "M": 1, "I": 0, "TH": 0, "N": 0, "J": 0 },
        "angular velocity": { "L": 0, "T": -1, "M": 0, "I": 0, "TH": 0, "N": 0, "J": 0 },
        "angular acceleration": { "L": 0, "T": -2, "M": 0, "I": 0, "TH": 0, "N": 0, "J": 0 },
        "heat flux density": { "L": 0, "T": -3, "M": 1, "I": 0, "TH": 0, "N": 0, "J": 0 },
        "entropy": { "L": 2, "T": -2, "M": 1, "I": 0, "TH": -1, "N": 0, "J": 0 },
        "specific entropy": { "L": 2, "T": -2, "M": 0, "I": 0, "TH": -1, "N": 0, "J": 0 },
        "thermal conductivity": { "L": 1, "T": -3, "M": 1, "I": 0, "TH": -1, "N": 0, "J": 0 },
        "energy density": { "L": -1, "T": -2, "M": 1, "I": 0, "TH": 0, "N": 0, "J": 0 },
        "electric field strength": { "L": 1, "T": -3, "M": 1, "I": -1, "TH": 0, "N": 0, "J": 0 },
        "electric charge density": { "L": -3, "T": 1, "M": 0, "I": 1, "TH": 0, "N": 0, "J": 0 },
        "electric flux density": { "L": -2, "T": 1, "M": 0, "I": 1, "TH": 0, "N": 0, "J": 0 },
        "permittivity": { "L": -3, "T": 4, "M": -1, "I": 2, "TH": 0, "N": 0, "J": 0 },
        "permeability": { "L": 1, "T": -2, "M": 1, "I": -2, "TH": 0, "N": 0, "J": 0 },
    }
}
...
document.getElementById("calc").addEventListener("click", function() {
    ...
    if (player.fir == "metre" && player.sec == "metre" && player.duhap == "÷") {
        ...
        imsi = "lux";
    } else if (player.fir == "radian" && player.sec == "second" && player.duhap == "÷") {
        imsi = "angular velocity";
    } else if (player.fir == "angular velocity" && player.sec == "second" && player.duhap == "÷") {
        imsi = "angular acceleration";
...
setInterval(function() {
    ...
    if (player.sec == "one") { document.getElementById("sec").innerHTML = "1"; } else { document.getElementById("sec").innerHTML = player.sec; }
